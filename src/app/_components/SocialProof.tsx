...
// Configuração dos Perfis com as imagens que você separou
const profiles = [
  {
    name: "Cenas Pica-Pau",
    image: "/picapau.png", // Certifique-se que este arquivo existe em public/
    alt: "Perfil Cenas Pica-Pau",
    followers: "910 mil"
  },
  {
    name: "Desenho Adulto",
    image: "/familiapesada.png", // Certifique-se que este arquivo existe em public/
    alt: "Perfil Família da Pesada",
    followers: "265 mil"
  },
  {
    name: "Evolution Milionária",
    image: "/evolutionmilionaria.png", // Certifique-se que este arquivo existe em public/
    alt: "Perfil Evolution Milionária",
    followers: "462 mil"
  },
  {
    name: "Motivacionais",
    image: "/motivacionais.png", // Certifique-se que este arquivo existe em public/
    ...
    <section id="resultados" className="py-8 md:py-10 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="font-display text-4xl md:text-5xl font-bold uppercase tracking-tighter text-white mb-4">
        ...
        {/* --- GRID DE PERFIS (AGORA COM IMAGENS INDIVIDUAIS) --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          {profiles.map((profile, index) => (
            ...
            >
              {/* Container da Imagem (Print do Perfil) */}
              <div className="aspect-[4/3] w-full relative bg-black/50">
                 ...
                 />
                 {/* Gradiente sutil na base da imagem para o texto ler melhor */}
           ...
           <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
              ...
              <div className="space-y-6">
                 <h3 className="font-display text-3xl md:text-4xl font-bold text-white uppercase leading-tight">
                    Crie um Negócio Lucrativo <span className="text-primary">Sem Aparecer.</span>
                 </h3>
                 ...
                 <Button size="lg" className="bg-primary mt-6 text-black font-bold rounded-full text-lg px-8 shadow-[0_0_20px_rgba(34,197,94,0.4)] hover:scale-105 transition-transform">
                 ...
                 {steps.map((step, index) => (
                    <div key={index} className="flex gap-4">
                       <div className="flex flex-col items-center">
                          <div className="w-12 h-12 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center text-primary shrink-0">
